...
def VGG16(include_top=True, weights='imagenet',
    ...
    if weights == 'imagenet':
        if include_top:
            ...
            weights_path = tf.keras.utils.get_file('vgg16_weights_tf_dim_ordering_tf_kernels_notop.h5',
                                    WEIGHTS_PATH_NO_TOP,
                                    cache_subdir='models')
...
if __name__ == '__main__':
    ...
    print('Predicted:', tf.keras.applications.densenet.decode_predictions(preds))
